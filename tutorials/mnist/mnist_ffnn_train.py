...
def run_training():
    ...
    with tf.Graph().as_default():
        ...
        for step in xrange(FLAGS.max_steps):
            ...
            # The return values are the activations from the `train_op` (which is discarded) and the `loss` Op.  
            # To inspect the values of your Ops or variables, you may include them
